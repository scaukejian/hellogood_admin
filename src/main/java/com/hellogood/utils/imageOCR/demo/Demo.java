 ...
 */
package com.hellogood.utils.imageOCR.demo;

import com.hellogood.utils.imageOCR.ImageClient;
...
/**
 * @author serenazhao imageOCR Demo代码
 */
public class Demo {

    public static void main(String[] args) {

        String appId = "1255423722";
        String secretId = "AKIDnRs54qAbZGjvrWj2vXsxlIchYCcohV0H";
        String secretKey = "A7qLcfV7VeaHkz0nNjsnUxCD1aw62kDT";
        String bucketName = "kj";

        ImageClient imageClient = new ImageClient(appId, secretId, secretKey);

        /*设置代理服务器*/
        //imageClient.setProxy(new HttpHost("127.0.0.1", 8081));
...
*/
    ...
    private static void ocrNameCard(ImageClient imageClient, String bucketName) {
       ...
       /* System.out.println("====================================================");
        ...
        try {
            namecardNameList[0] = "ocr_namecard_03.jpg";
    ...
    private static void ocrGeneral(ImageClient imageClient, String bucketName) {
        ...
        //2. 图片内容方式
        System.out.println("====================================================");
        GeneralOcrRequest request = new GeneralOcrRequest(bucketName, new File("assets", "ocr_namecard_04.jpg"));
        ret = imageClient.generalOcr(request);
        System.out.println("ocrGeneral:" + ret);
    }
    ...
    private static void imageTag(ImageClient imageClient, String bucketName) {
        ...
        // 1. url方式
        System.out.println("====================================================");
        String tagUrl = "http://youtu.qq.com/app/img/experience/imageOCR/icon_imag_01.jpg";
