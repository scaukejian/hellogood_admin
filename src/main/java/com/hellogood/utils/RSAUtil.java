...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String passwordMi = encrypt(password);
        System.out.println("加密后: " + passwordMi);
        String newPassword = decrypt(passwordMi);
        System.out.println("解密后: " + newPassword);
    }
    ...
    public static String decrypt(String password) throws Exception{
        ...
        return RSAUtil.decryptByPrivateKey(password, priKey);
    }
}
